...
const Profile = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="relative min-h-screen pt-5 -mt-4 bg-main">
          ...
          <div className="flex flex-col md:w-1/2 lg:mx-auto ">
            <div className="flex flex-col gap-2 ml-2  sm:w-96 xl:w-[472px] md:mx-auto ">
              ...
              <div className="flex items-center ">
                ...
                <div>
                  <h5 className="text-lg font-medium lowercase font-Poppins text-cyanEboox sm:text-3xl">
                    username
                  </h5>
                  <p className="font-roboto text-base sm:text-xl text-[#636F64]/50 ">
                    Username
            ...
            <button className="w-72 mx-auto py-2 mt-4 bg-[#FF4D00] text-white text-xl md:text-2xl font-bold  sm:w-96 rounded-full xl:w-[472px]">
              Logout
            </button>
          </div>
        </div>
          ...
          <>
            <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none">
              <div className="absolute top-36 sm:top-30 mx-auto  w-[320px] sm:w-[550px] lg:w-[700px] ">
                <div className="flex flex-col w-full border-0 rounded-lg shadow-lg outline-none bg-main focus:outline-none">
