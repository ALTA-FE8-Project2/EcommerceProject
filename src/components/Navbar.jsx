...
import { MdOutlineShoppingCart, MdSearch, MdOutlineHistory, MdOutlineAccountCircle } from "react-icons/md";
                ...
                <div className="flex flex-wrap items-center w-full px-2 mx-auto md:px-4">
                    <div className="relative flex items-center justify-between w-full ">
                        ...
                        <Link to="/" className="flex items-center">
                            <img src="https://cdn.discordapp.com/attachments/1017919526748299295/1018847868905324564/logo_2.png" alt="logo" className="w-[40px] sm:w-[50px]" />
                            <h1 className="hidden mx-3 text-2xl italic font-bold font-poppins text-main sm:block ">eboox</h1>
                        </Link>
                        ...
                        <ul className="flex-col justify-between hidden list-none w-52 lg:flex lg:flex-row lg:ml-auto ">
                            ...
                            <li className="nav-item">
                                <Link to="/cart" className="flex items-center ">
                                    ...
                                    <h3 className="ml-3 text-xl font-medium font-poppins lg:hidden">Cart</h3>
                                </Link>
                            </li>
                            ...
                            <li className="nav-item">
                                <Link to="/history-order" className="flex items-center">
                                    ...
                                    <h3 className="ml-3 text-xl font-medium font-poppins lg:hidden">Hystory Order</h3>
                                </Link>
                            </li>
                            ...
                            <li className="nav-item">
                                <Link to="/profile" className="flex items-center">
                                    ...
                                    <h3 className="ml-3 text-xl font-medium font-poppins lg:hidden ">Profile</h3>
                                </Link>
                            </li>
                        </ul>
                    </div>
